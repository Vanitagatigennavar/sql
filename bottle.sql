...
createDate timestamp default now(),createdBy varchar(20)default 'Varshini');
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES('1','TUPPERWEAR','PINK','PLASTIC','Mangalore');
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(2,'AQUAFINA','RED','GLASS','shreenagar'); 
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(3,'BUTTERFLY','SILVER','FIBRE','kushalnagar'); 
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(4,'EVIAN','WHITE','METAL','hubli'); 
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(5,'MILTON','BLACK','STEEL','btm'); 
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(6,'DAYLIGHT','MATTE','ALUMINIUM','bangalore');  
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(7,'KAVACH','GREEN','POLY','DHARWAD'); 
INSERT bottle(serialNumber,brand,bottleColor,bottleMaterial,bottleLocation)VALUES(8,'PUMA','GOLD','RESIN','TEJASWINAGAR'); 
select*from bottle;

SELECT * from bottle where bottleLocation='mangalore' order by serialNumber;
